...
def show_patient_details(list_of_patients):
    patient_titles = ['Patient ID', 'Name', 'Age', 'Gender', 'Date of birth (DD-MM-YYYY)',
                     ...
                     'ID number', 'Weight (kg)', 'Height (cm)', 'Address',
                     'City', 'Province', 'Postal code', "Next of kin's name",
                     "Next of kin's relation to patient",
                     "Next of kin's contact number", 'Email',
...
class Patient:
    ...
    def add_patient(self):
        ...
        self.id_number = st.text_input('ID / Passport Number')
        ...
        self.state = st.text_input('Province')
        ...
        email_id = st.text_input('Email (optional)')
            ...
            with conn:
                c.execute(
                    ...
                    (
                        ...
                        contact_number_1, contact_number_2, id_number,
                    ...
                    """,
                    {
                        ...
                        'uid': self.id_number, 'weight': self.weight,
    ...
    def update_patient(self):
        ...
        if id == '':
            ...
            self.city = st.text_input('City')
            self.state = st.text_input('Province')
            self.pin_code = st.text_input('Postal code')
            self.next_of_kin_name = st.text_input("Next of kin's name")
            self.next_of_kin_relation_to_patient = st.text_input("Next of kin's relation to patient")
            self.next_of_kin_contact_number = st.text_input("Next of kin's contact number")
            email_id = st.text_input('Email (optional)')
